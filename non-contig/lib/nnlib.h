...
typedef struct {
  float **weights;         // 2D array: weights[input_size][output_size]
  float *biases;           // 1D array: biases[output_size]
  float **weight_momentum; // 2D array: weight_momentum[input_size][output_size]
  float *bias_momentum;    // 1D array: bias_momentum[output_size]
...
void randomize_weights_2d(float **weights, int size, int output_size,
                          float scale);
